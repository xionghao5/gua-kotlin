...
fun generator() {
    FastAutoGenerator.create(
        "jdbc:mysql://localhost:3306/kotlin2",
        "root",
        "888"
    )
        .globalConfig { builder: GlobalConfig.Builder ->
            builder.author("xiong") // 设置作者
                ...
                .outputDir("C://temp//") // 指定输出目录
        }
        .packageConfig { builder: PackageConfig.Builder ->
            builder.parent("com.gua.j8kgweb.module.user") // 设置父包名
//                .moduleName("system") // 设置父包模块名
                .pathInfo(Collections.singletonMap(OutputFile.xml, "C://temp")) // 设置mapperXml生成路径
        }
